...
<p align="center">
    ...
    <a href="https://github.com/RailonA/weatherApp/issues">Report Bug</a>&#10023;
...
<img src="./src/assets/screenshotError.png" alt="Screenshot error" style="margin: auto; display: block;">
...
3. Copy and paste the following code into the Terminal :
   ```bash
   $ git clone git@github.com:RailonA/weatherApp.git
   ```
...
Feel free to check the [issues page](https://github.com/RailonA/weatherApp/issues).
